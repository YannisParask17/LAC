...
hawc2s_path = 'IIIB_scaled_turbine_control_Julio\hawc2s_files\IIIB_scaled_turbine_JULIO.opt'  # path to .pwr or .opt file
stats_path = 'IIIB_scaled_turbine_control_Julio\postprocess_hawc2\scaled_turbine_turb_stats.hdf5'  # path to mean steady stats
...
stats_path_dtu10mw = 'IIIB_scaled_turbine_control_Julio\postprocess_hawc2/dtu_10mw_turb_stats.hdf5'  # path to mean steady stats
save_path = '' 
