...
opt_path = '../IIIB_scaled_turbine_Julio/IIIB_scaled_turbine_JULIO.opt'  # path to opt file, to be added as an exercise
cmb_paths = {'structural': '../IIIB_scaled_turbine_Julio/10mw_3b_whole_turbine_structure.cmb',
             'aeroelastic': '../IIIB_scaled_turbine/10mw_3b_whole_turbine_aero.cmb'
             }
...
for antype in ['structural', 'aeroelastic']:
    ...
    # fig.legend(loc='outside lower center', bbox_to_anchor=(0.5, -0.2), handles=lines,
               labels=mode_names[antype], ncols=5)
